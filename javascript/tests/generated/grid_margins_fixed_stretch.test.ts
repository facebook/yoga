 ...
 *
 * @generated SignedSource<<0a731416a43705aa7f0d5bbf3eaed702>>
...
test('grid_margins_fixed_stretch', () => {
  ...
  try {
    ...
    expect(root_child0.getComputedTop()).toBe(11);
    ...
    expect(root_child0.getComputedLeft()).toBe(138);
    expect(root_child0.getComputedTop()).toBe(11);
    expect(root_child0.getComputedWidth()).toBe(20);
    expect(root_child0.getComputedHeight()).toBe(20);
