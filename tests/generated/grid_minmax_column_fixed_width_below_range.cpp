 ...
 *
 * clang-format off
 * @generated SignedSource<<ec4beccfae30e7c6db90b33edc8c3b8c>>
...
TEST(YogaTest, grid_minmax_column_fixed_width_below_range) {
  ...
  ASSERT_FLOAT_EQ(-10, YGNodeLayoutGetLeft(root_child8));
  ASSERT_FLOAT_EQ(80, YGNodeLayoutGetTop(root_child8));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetWidth(root_child8));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetHeight(root_child8));
