 ...
 *
 * @generated SignedSource<<57c87ca8fbfd6c73690390259e03e02b>>
...
test('grid_margins_fixed_end', () => {
  ...
  try {
    ...
    expect(root_child0.getComputedLeft()).toBe(58);
    ...
    expect(root_child0.getComputedLeft()).toBe(124);
    expect(root_child0.getComputedTop()).toBe(27);
    expect(root_child0.getComputedWidth()).toBe(20);
    expect(root_child0.getComputedHeight()).toBe(20);
