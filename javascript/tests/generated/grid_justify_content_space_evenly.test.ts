 ...
 *
 * @generated SignedSource<<ce699772b51a2745de4f5061d6ed9a47>>
...
test('grid_justify_content_space_evenly', () => {
  ...
  try {
    ...
    expect(root_child5.getComputedLeft()).toBe(140);
    ...
    expect(root_child8.getComputedLeft()).toBe(140);
    ...
    expect(root_child3.getComputedLeft()).toBe(140);
    expect(root_child3.getComputedTop()).toBe(40);
    expect(root_child3.getComputedWidth()).toBe(40);
    expect(root_child3.getComputedHeight()).toBe(40);
    ...
    expect(root_child6.getComputedLeft()).toBe(140);
    expect(root_child6.getComputedTop()).toBe(80);
    expect(root_child6.getComputedWidth()).toBe(40);
    expect(root_child6.getComputedHeight()).toBe(40);
