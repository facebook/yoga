 ...
 *
 * @generated SignedSource<<0bd72091418e5bef19a969cf97f3d506>>
...
test('grid_justify_content_space_around', () => {
  ...
  try {
    ...
    expect(root_child0.getComputedLeft()).toBe(13);
    ...
    expect(root_child2.getComputedLeft()).toBe(147);
    ...
    expect(root_child5.getComputedLeft()).toBe(147);
    ...
    expect(root_child6.getComputedLeft()).toBe(13);
    ...
    expect(root_child8.getComputedLeft()).toBe(147);
    ...
    expect(root_child0.getComputedLeft()).toBe(147);
    expect(root_child0.getComputedTop()).toBe(0);
    expect(root_child0.getComputedWidth()).toBe(40);
    expect(root_child0.getComputedHeight()).toBe(40);
    ...
    expect(root_child2.getComputedLeft()).toBe(13);
    expect(root_child2.getComputedTop()).toBe(0);
    expect(root_child2.getComputedWidth()).toBe(40);
    expect(root_child2.getComputedHeight()).toBe(40);

    expect(root_child3.getComputedLeft()).toBe(147);
    expect(root_child3.getComputedTop()).toBe(40);
    expect(root_child3.getComputedWidth()).toBe(40);
    expect(root_child3.getComputedHeight()).toBe(40);
    ...
    expect(root_child5.getComputedLeft()).toBe(13);
    expect(root_child5.getComputedTop()).toBe(40);
    expect(root_child5.getComputedWidth()).toBe(40);
    expect(root_child5.getComputedHeight()).toBe(40);

    expect(root_child6.getComputedLeft()).toBe(147);
    expect(root_child6.getComputedTop()).toBe(80);
    expect(root_child6.getComputedWidth()).toBe(40);
    expect(root_child6.getComputedHeight()).toBe(40);
    ...
    expect(root_child8.getComputedLeft()).toBe(13);
    expect(root_child8.getComputedTop()).toBe(80);
    expect(root_child8.getComputedWidth()).toBe(40);
    expect(root_child8.getComputedHeight()).toBe(40);
  } finally {
