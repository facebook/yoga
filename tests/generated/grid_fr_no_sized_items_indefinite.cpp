 ...
 *
 * clang-format off
 * @generated SignedSource<<85f422958840e725d6e08f8c3e312e44>>
...
TEST(YogaTest, grid_fr_no_sized_items_indefinite) {
  ...
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetTop(root_child6));
  ...
  ASSERT_FLOAT_EQ(0, YGNodeLayoutGetWidth(root_child7));
  ASSERT_FLOAT_EQ(0, YGNodeLayoutGetHeight(root_child7));
  ...
  ASSERT_FLOAT_EQ(0, YGNodeLayoutGetHeight(root_child8));
