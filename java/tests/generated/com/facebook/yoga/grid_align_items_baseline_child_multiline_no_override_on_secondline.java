 ...
 *
 * @generated SignedSource<<b7d1c5ffca9823aec76ebf397dd55e2c>>
...
public class grid_align_items_baseline_child_multiline_no_override_on_secondline {
  ...
  @Test
  public void test_grid_align_items_baseline_child_multiline_no_override_on_secondline() {
    ...
    YogaGridTrackList root_child1GridTemplateColumns = new YogaGridTrackList();
    root_child1GridTemplateColumns.addTrack(YogaGridTrackValue.auto());
    root_child1GridTemplateColumns.addTrack(YogaGridTrackValue.auto());
    ...
    root_child1_child1.setDisplay(YogaDisplay.GRID);
    ...
    root_child1_child2.setDisplay(YogaDisplay.GRID);
    ...
    root_child1_child3.setDisplay(YogaDisplay.GRID);
