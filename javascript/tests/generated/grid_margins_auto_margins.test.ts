 ...
 *
 * @generated SignedSource<<39c0e496646befe19dbe84a1ea37de7a>>
...
test('grid_margins_auto_margins', () => {
  ...
  try {
    ...
    root_child2.setMargin(Edge.Left, "auto");
    root_child2.setMargin(Edge.Top, 0);
    root_child2.setMargin(Edge.Right, "auto");
    root_child2.setMargin(Edge.Bottom, 0);
    ...
    root_child4.setMargin(Edge.Left, 0);
    root_child4.setMargin(Edge.Top, "auto");
    root_child4.setMargin(Edge.Right, 0);
    root_child4.setMargin(Edge.Bottom, "auto");
    ...
    root_child6.setMargin(Edge.Left, "auto");
    root_child6.setMargin(Edge.Top, "auto");
    root_child6.setMargin(Edge.Right, "auto");
    root_child6.setMargin(Edge.Bottom, "auto");
