...
#define YG_UNDEFINED_VALUES \
  { DINIT(value, YGUndefined), DINIT(unit, YGUnitUndefined) }

#define YG_AUTO_VALUES \
  { DINIT(value, YGUndefined), DINIT(unit, YGUnitAuto) }
...
static const YGStyle gYGNodeStyleDefaults = {
    DINIT(direction, YGDirectionInherit),
    DINIT(flexDirection, YGFlexDirectionColumn),
    DINIT(justifyContent, YGJustifyFlexStart),
    DINIT(alignContent, YGAlignFlexStart),
    DINIT(alignItems, YGAlignStretch),
    DINIT(alignSelf, YGAlignAuto),
    DINIT(positionType, YGPositionTypeRelative),
    DINIT(flexWrap, YGWrapNoWrap),
    DINIT(overflow, YGOverflowVisible),
    DINIT(display, YGDisplayFlex),
    DINIT(flex, YGUndefined),
    DINIT(flexGrow, YGUndefined),
    DINIT(flexShrink, YGUndefined),
    DINIT(flexBasis, YG_AUTO_VALUES),
    DINIT(margin, {{YG_UNDEFINED_VALUES,
                YG_UNDEFINED_VALUES,
                YG_UNDEFINED_VALUES,
                YG_UNDEFINED_VALUES,
                YG_UNDEFINED_VALUES,
                ...
                YG_UNDEFINED_VALUES,
                YG_UNDEFINED_VALUES}}),
    DINIT(position, {{YG_UNDEFINED_VALUES,
                  YG_UNDEFINED_VALUES,
                  YG_UNDEFINED_VALUES,
                  YG_UNDEFINED_VALUES,
                  YG_UNDEFINED_VALUES,
                  ...
                  YG_UNDEFINED_VALUES,
                  YG_UNDEFINED_VALUES}}),
    DINIT(padding, {{YG_UNDEFINED_VALUES,
                 YG_UNDEFINED_VALUES,
                 YG_UNDEFINED_VALUES,
                 YG_UNDEFINED_VALUES,
                 YG_UNDEFINED_VALUES,
                 ...
                 YG_UNDEFINED_VALUES,
                 YG_UNDEFINED_VALUES}}),
    DINIT(border, {{YG_UNDEFINED_VALUES,
                YG_UNDEFINED_VALUES,
                YG_UNDEFINED_VALUES,
                YG_UNDEFINED_VALUES,
                YG_UNDEFINED_VALUES,
                ...
                YG_UNDEFINED_VALUES,
                YG_UNDEFINED_VALUES}}),
    DINIT(dimensions, {{YG_AUTO_VALUES, YG_AUTO_VALUES}}),
    DINIT(minDimensions, {{YG_UNDEFINED_VALUES, YG_UNDEFINED_VALUES}}),
    DINIT(maxDimensions, {{YG_UNDEFINED_VALUES, YG_UNDEFINED_VALUES}}),
    DINIT(aspectRatio, YGUndefined),
};

static const YGLayout gYGNodeLayoutDefaults = {
    DINIT(position, {}),
    DINIT(dimensions, {{YGUndefined, YGUndefined}}),
    DINIT(margin, {}),
    DINIT(border, {}),
    DINIT(padding, {}),
    DINIT(direction, YGDirectionInherit),
    DINIT(computedFlexBasisGeneration, 0),
    DINIT(computedFlexBasis, YGUndefined),
    DINIT(hadOverflow, false),
    DINIT(generationCount, 0),
    DINIT(lastParentDirection, (YGDirection)-1),
    DINIT(nextCachedMeasurementsIndex, 0),
    DINIT(cachedMeasurements, {}),
    DINIT(measuredDimensions, {{YGUndefined, YGUndefined}}),
    DINIT(cachedLayout,
        {
            DINIT(availableWidth, 0),
            DINIT(availableHeight, 0),
            DINIT(widthMeasureMode, (YGMeasureMode)-1),
            DINIT(heightMeasureMode, (YGMeasureMode)-1),
            DINIT(computedWidth, -1),
            DINIT(computedHeight, -1),
        }),
    DINIT(didUseLegacyFlag, false),
    DINIT(doesLegacyStretchFlagAffectsLayout, false),
};
