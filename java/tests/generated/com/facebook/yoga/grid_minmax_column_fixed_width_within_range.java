 ...
 *
 * @generated SignedSource<<3e18fdf32294e8fd3b4aa4dd3426b933>>
 * generated by gentest/src/GentestDriver.ts from gentest/fixtures/grid_minmax_column_fixed_width_within_range.html
 */
...
public class grid_minmax_column_fixed_width_within_range {
  ...
  @Test
  public void test_grid_minmax_column_fixed_width_within_range() {
    ...
    assertEquals(30f, root_child7.getLayoutWidth(), 0.0f);
    assertEquals(40f, root_child7.getLayoutHeight(), 0.0f);

    assertEquals(70f, root_child8.getLayoutX(), 0.0f);
    ...
    assertEquals(70f, root_child6.getLayoutX(), 0.0f);
    assertEquals(80f, root_child6.getLayoutY(), 0.0f);
    assertEquals(40f, root_child6.getLayoutWidth(), 0.0f);
    assertEquals(40f, root_child6.getLayoutHeight(), 0.0f);
