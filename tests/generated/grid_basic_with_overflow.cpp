 ...
 *
 * clang-format off
 * @generated SignedSource<<f65936a6e0197b4ab7d8242e940bff08>>
...
TEST(YogaTest, grid_basic_with_overflow) {
  ...
  ASSERT_FLOAT_EQ(0, YGNodeLayoutGetLeft(root_child9));
  ASSERT_FLOAT_EQ(120, YGNodeLayoutGetTop(root_child9));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetWidth(root_child9));
  ASSERT_FLOAT_EQ(0, YGNodeLayoutGetHeight(root_child9));
  ...
  ASSERT_FLOAT_EQ(80, YGNodeLayoutGetLeft(root_child9));
  ASSERT_FLOAT_EQ(120, YGNodeLayoutGetTop(root_child9));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetWidth(root_child9));
  ASSERT_FLOAT_EQ(0, YGNodeLayoutGetHeight(root_child9));
