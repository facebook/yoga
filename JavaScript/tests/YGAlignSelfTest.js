...
<<<<<<< HEAD
 // @Generated by gentest/gentest.rb from gentest/fixtures/Yoga.AlignSelfTest.html
...
(function() {
  ...
  Yoga.nodeStyleSetAlignSelf(root_child0, Yoga.AlignCenter);
...
(function() {
  ...
  const root_child0 = Yoga.nodeNew();
  Yoga.nodeStyleSetAlignSelf(root_child0, Yoga.AlignFlexEnd);
  Yoga.nodeStyleSetWidth(root_child0, 10);
  Yoga.nodeStyleSetHeight(root_child0, 10);
  Yoga.nodeInsertChild(root, root_child0, 0);
  Yoga.nodeCalculateLayout(root, Yoga.Undefined, Yoga.Undefined, Yoga.DirectionLTR);
...
(function() {
  ...
  const root_child0 = Yoga.nodeNew();
  Yoga.nodeStyleSetAlignSelf(root_child0, Yoga.AlignFlexStart);
  Yoga.nodeStyleSetWidth(root_child0, 10);
  Yoga.nodeStyleSetHeight(root_child0, 10);
  Yoga.nodeInsertChild(root, root_child0, 0);
  Yoga.nodeCalculateLayout(root, Yoga.Undefined, Yoga.Undefined, Yoga.DirectionLTR);
