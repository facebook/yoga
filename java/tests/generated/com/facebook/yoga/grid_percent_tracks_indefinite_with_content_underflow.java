 ...
 *
 * @generated SignedSource<<89091a4750df0c888922a6ce242730f8>>
...
public class grid_percent_tracks_indefinite_with_content_underflow {
  ...
  @Test
  public void test_grid_percent_tracks_indefinite_with_content_underflow() {
    ...
    assertEquals(10f, root_child4.getLayoutWidth(), 0.0f);
    ...
    assertEquals(30f, root_child6.getLayoutX(), 0.0f);
    assertEquals(30f, root_child6.getLayoutY(), 0.0f);
    assertEquals(30f, root_child6.getLayoutWidth(), 0.0f);
    assertEquals(60f, root_child6.getLayoutHeight(), 0.0f);
