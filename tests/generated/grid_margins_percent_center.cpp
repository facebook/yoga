 ...
 *
 * clang-format off
 * @generated SignedSource<<e522b2f2bd8c2cdd111feafb0ac6de29>>
...
TEST(YogaTest, grid_margins_percent_center) {
  ...
  ASSERT_FLOAT_EQ(9, YGNodeLayoutGetTop(root_child0));
  ...
  ASSERT_FLOAT_EQ(41, YGNodeLayoutGetLeft(root_child0));
  ASSERT_FLOAT_EQ(9, YGNodeLayoutGetTop(root_child0));
  ASSERT_FLOAT_EQ(20, YGNodeLayoutGetWidth(root_child0));
  ASSERT_FLOAT_EQ(20, YGNodeLayoutGetHeight(root_child0));
