 ...
 *
 * @generated SignedSource<<b79ea3720b33242106b42a452eef87b3>>
...
test('grid_align_content_space_around', () => {
  ...
  try {
    ...
    expect(root_child0.getComputedTop()).toBe(13);
    ...
    expect(root_child1.getComputedTop()).toBe(13);
    ...
    expect(root_child2.getComputedTop()).toBe(13);
    ...
    expect(root_child6.getComputedTop()).toBe(147);
    ...
    expect(root_child7.getComputedTop()).toBe(147);
    ...
    expect(root_child8.getComputedTop()).toBe(147);
    ...
    expect(root_child3.getComputedLeft()).toBe(160);
    expect(root_child3.getComputedTop()).toBe(80);
    expect(root_child3.getComputedWidth()).toBe(40);
    expect(root_child3.getComputedHeight()).toBe(40);
    ...
    expect(root_child6.getComputedLeft()).toBe(160);
    expect(root_child6.getComputedTop()).toBe(147);
    expect(root_child6.getComputedWidth()).toBe(40);
    expect(root_child6.getComputedHeight()).toBe(40);
