 ...
 *
 * @generated SignedSource<<1ac12c4541aeddc58e1ebe69b5bc7d50>>
...
test('grid_align_content_space_evenly', () => {
  ...
  try {
    ...
    expect(root_child6.getComputedTop()).toBe(140);
    ...
    expect(root_child7.getComputedTop()).toBe(140);
    ...
    expect(root_child8.getComputedTop()).toBe(140);
