 ...
 *
 * @generated SignedSource<<6326ba55ec9aa9ad5d1618b96650690b>>
...
test('grid_absolute_with_padding_and_margin', () => {
  ...
  try {
    ...
    root_child1.setPosition(Edge.Bottom, 10);
    root_child1.setPosition(Edge.Left, 10);
    ...
    expect(root_child0.getComputedLeft()).toBe(178);
    ...
    expect(root_child1.getComputedTop()).toBe(147);
