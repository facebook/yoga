 ...
 *
 * clang-format off
 * @generated SignedSource<<a1adcad440384195eb496209a61df199>>
 * generated by gentest/src/GentestDriver.ts from gentest/fixtures/grid_justify_content_space_around.html
 */
...
TEST(YogaTest, grid_justify_content_space_around) {
  ...
  ASSERT_FLOAT_EQ(13, YGNodeLayoutGetLeft(root_child0));
  ...
  ASSERT_FLOAT_EQ(147, YGNodeLayoutGetLeft(root_child2));
  ...
  ASSERT_FLOAT_EQ(147, YGNodeLayoutGetLeft(root_child5));
  ...
  ASSERT_FLOAT_EQ(13, YGNodeLayoutGetLeft(root_child6));
  ...
  ASSERT_FLOAT_EQ(147, YGNodeLayoutGetLeft(root_child8));
  ...
  ASSERT_FLOAT_EQ(147, YGNodeLayoutGetLeft(root_child0));
  ASSERT_FLOAT_EQ(0, YGNodeLayoutGetTop(root_child0));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetWidth(root_child0));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetHeight(root_child0));
  ...
  ASSERT_FLOAT_EQ(13, YGNodeLayoutGetLeft(root_child2));
  ASSERT_FLOAT_EQ(0, YGNodeLayoutGetTop(root_child2));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetWidth(root_child2));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetHeight(root_child2));

  ASSERT_FLOAT_EQ(147, YGNodeLayoutGetLeft(root_child3));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetTop(root_child3));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetWidth(root_child3));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetHeight(root_child3));
  ...
  ASSERT_FLOAT_EQ(13, YGNodeLayoutGetLeft(root_child5));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetTop(root_child5));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetWidth(root_child5));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetHeight(root_child5));

  ASSERT_FLOAT_EQ(147, YGNodeLayoutGetLeft(root_child6));
  ASSERT_FLOAT_EQ(80, YGNodeLayoutGetTop(root_child6));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetWidth(root_child6));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetHeight(root_child6));
  ...
  ASSERT_FLOAT_EQ(13, YGNodeLayoutGetLeft(root_child8));
  ASSERT_FLOAT_EQ(80, YGNodeLayoutGetTop(root_child8));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetWidth(root_child8));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetHeight(root_child8));
