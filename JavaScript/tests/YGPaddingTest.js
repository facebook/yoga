...
<<<<<<< HEAD
 // @Generated by gentest/gentest.rb from gentest/fixtures/Yoga.PaddingTest.html
...
(function() {
  ...
  Yoga.nodeStyleSetPadding(root, Yoga.EdgeStart, 10);
  Yoga.nodeStyleSetPadding(root, Yoga.EdgeEnd, 20);
  Yoga.nodeStyleSetPadding(root, Yoga.EdgeBottom, 20);
  Yoga.nodeStyleSetWidth(root, 100);
  Yoga.nodeStyleSetHeight(root, 100);
...
(function() {
  ...
  const root_child0 = Yoga.nodeNew();
  Yoga.nodeStyleSetPadding(root_child0, Yoga.EdgeLeft, 20);
  Yoga.nodeStyleSetPadding(root_child0, Yoga.EdgeTop, 20);
  Yoga.nodeStyleSetPadding(root_child0, Yoga.EdgeRight, 20);
  Yoga.nodeStyleSetPadding(root_child0, Yoga.EdgeBottom, 20);
  ...
  ASSERT_FLOAT_EQ(200, Yoga.nodeLayoutGetHeight(root));

  ASSERT_FLOAT_EQ(100, Yoga.nodeLayoutGetLeft(root_child0));
  ASSERT_FLOAT_EQ(100, Yoga.nodeLayoutGetTop(root_child0));
...
describe('YGPaddingTest', () => {
  ...
  it('child_with_padding_align_end', () => {
    ...
    expect(Yoga.nodeLayoutGetHeight(root)).toBe(200);

    expect(Yoga.nodeLayoutGetLeft(root_child0)).toBe(100);
    expect(Yoga.nodeLayoutGetTop(root_child0)).toBe(100);
