...
public abstract class YogaNodeJNIBase extends YogaNode implements Cloneable {
  ...
  public YogaJustify getJustifyItems() {
    return YogaJustify.fromInt(YogaNative.jni_YGNodeStyleGetJustifyItemsJNI(mNativePointer));
  }

  public void setJustifyItems(YogaJustify justifyItems) {
    YogaNative.jni_YGNodeStyleSetJustifyItemsJNI(mNativePointer, justifyItems.intValue());
  }

  public YogaJustify getJustifySelf() {
    return YogaJustify.fromInt(YogaNative.jni_YGNodeStyleGetJustifySelfJNI(mNativePointer));
  }

  public void setJustifySelf(YogaJustify justifySelf) {
    YogaNative.jni_YGNodeStyleSetJustifySelfJNI(mNativePointer, justifySelf.intValue());
  }
