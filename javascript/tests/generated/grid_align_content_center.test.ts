 ...
 *
 * @generated SignedSource<<c9be777f7cb1c9f92e7c47145102f3dc>>
...
test('grid_align_content_center', () => {
  ...
  try {
    ...
    expect(root_child6.getComputedTop()).toBe(120);
    ...
    expect(root_child7.getComputedTop()).toBe(120);
    ...
    expect(root_child8.getComputedTop()).toBe(120);
