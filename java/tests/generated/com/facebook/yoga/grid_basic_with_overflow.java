 ...
 *
 * @generated SignedSource<<d954529349c5223e9b97fdb386af27bc>>
 * generated by gentest/src/GentestDriver.ts from gentest/fixtures/grid_basic_with_overflow.html
 */
...
public class grid_basic_with_overflow {
  ...
  @Test
  public void test_grid_basic_with_overflow() {
    ...
    assertEquals(0f, root_child9.getLayoutX(), 0.0f);
    assertEquals(120f, root_child9.getLayoutY(), 0.0f);
    assertEquals(40f, root_child9.getLayoutWidth(), 0.0f);
    assertEquals(0f, root_child9.getLayoutHeight(), 0.0f);
    ...
    assertEquals(80f, root_child9.getLayoutX(), 0.0f);
    assertEquals(120f, root_child9.getLayoutY(), 0.0f);
    assertEquals(40f, root_child9.getLayoutWidth(), 0.0f);
    assertEquals(0f, root_child9.getLayoutHeight(), 0.0f);
  }
