...
TEST(CSSLayoutTest, align_content_flex_start) {
  ...
  CSSNodeStyleSetWidth(root_child3, 50f);
  CSSNodeStyleSetHeight(root_child3, 10f);
  CSSNodeInsertChild(root, root_child3, 3);

  const CSSNodeRef root_child4 = CSSNodeNew();
  CSSNodeStyleSetWidth(root_child4, 50f);
  CSSNodeStyleSetHeight(root_child4, 10f);
  ...
  ASSERT_FLOAT_EQ(50f, CSSNodeLayoutGetWidth(root_child3));
  ASSERT_FLOAT_EQ(10f, CSSNodeLayoutGetHeight(root_child3));

  ASSERT_FLOAT_EQ(0f, CSSNodeLayoutGetLeft(root_child4));
  ASSERT_FLOAT_EQ(40f, CSSNodeLayoutGetTop(root_child4));
  ASSERT_FLOAT_EQ(50f, CSSNodeLayoutGetWidth(root_child4));
  ASSERT_FLOAT_EQ(10f, CSSNodeLayoutGetHeight(root_child4));
  ...
  ASSERT_FLOAT_EQ(50f, CSSNodeLayoutGetLeft(root_child2));
  ASSERT_FLOAT_EQ(20f, CSSNodeLayoutGetTop(root_child2));
  ASSERT_FLOAT_EQ(50f, CSSNodeLayoutGetWidth(root_child2));
  ASSERT_FLOAT_EQ(10f, CSSNodeLayoutGetHeight(root_child2));

  ASSERT_FLOAT_EQ(50f, CSSNodeLayoutGetLeft(root_child3));
  ASSERT_FLOAT_EQ(30f, CSSNodeLayoutGetTop(root_child3));
  ASSERT_FLOAT_EQ(50f, CSSNodeLayoutGetWidth(root_child3));
  ASSERT_FLOAT_EQ(10f, CSSNodeLayoutGetHeight(root_child3));

  ASSERT_FLOAT_EQ(50f, CSSNodeLayoutGetLeft(root_child4));
  ASSERT_FLOAT_EQ(40f, CSSNodeLayoutGetTop(root_child4));
  ASSERT_FLOAT_EQ(50f, CSSNodeLayoutGetWidth(root_child4));
  ASSERT_FLOAT_EQ(10f, CSSNodeLayoutGetHeight(root_child4));
...
TEST(CSSLayoutTest, align_content_stretch) {
  ...
  ASSERT_FLOAT_EQ(50f, CSSNodeLayoutGetWidth(root_child2));
  ASSERT_FLOAT_EQ(0f, CSSNodeLayoutGetHeight(root_child2));

  ASSERT_FLOAT_EQ(0f, CSSNodeLayoutGetLeft(root_child3));
  ASSERT_FLOAT_EQ(0f, CSSNodeLayoutGetTop(root_child3));
  ASSERT_FLOAT_EQ(50f, CSSNodeLayoutGetWidth(root_child3));
  ASSERT_FLOAT_EQ(0f, CSSNodeLayoutGetHeight(root_child3));

  ASSERT_FLOAT_EQ(0f, CSSNodeLayoutGetLeft(root_child4));
  ASSERT_FLOAT_EQ(0f, CSSNodeLayoutGetTop(root_child4));
  ASSERT_FLOAT_EQ(50f, CSSNodeLayoutGetWidth(root_child4));
  ASSERT_FLOAT_EQ(0f, CSSNodeLayoutGetHeight(root_child4));
