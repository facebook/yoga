 ...
 *
 * @generated SignedSource<<54b5ad5814b7700c8db5d57bade6a2ab>>
...
test('grid_align_content_end', () => {
  ...
  try {
    ...
    expect(root_child6.getComputedTop()).toBe(160);
    ...
    expect(root_child8.getComputedTop()).toBe(160);
