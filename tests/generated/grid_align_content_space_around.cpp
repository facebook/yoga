 ...
 *
 * clang-format off
 * @generated SignedSource<<ee0c6cc80c4149dd37a88e18f53a9784>>
 * generated by gentest/src/GentestDriver.ts from gentest/fixtures/grid_align_content_space_around.html
 */
...
TEST(YogaTest, grid_align_content_space_around) {
  ...
  ASSERT_FLOAT_EQ(13, YGNodeLayoutGetTop(root_child0));
  ...
  ASSERT_FLOAT_EQ(13, YGNodeLayoutGetTop(root_child1));
  ...
  ASSERT_FLOAT_EQ(13, YGNodeLayoutGetTop(root_child2));
  ...
  ASSERT_FLOAT_EQ(147, YGNodeLayoutGetTop(root_child6));
  ...
  ASSERT_FLOAT_EQ(147, YGNodeLayoutGetTop(root_child7));
  ...
  ASSERT_FLOAT_EQ(147, YGNodeLayoutGetTop(root_child8));
  ...
  ASSERT_FLOAT_EQ(160, YGNodeLayoutGetLeft(root_child6));
  ASSERT_FLOAT_EQ(147, YGNodeLayoutGetTop(root_child6));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetWidth(root_child6));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetHeight(root_child6));
