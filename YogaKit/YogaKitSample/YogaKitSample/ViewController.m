...
- (void)viewDidLoad
{
    ...
    root.yoga.width = YGPoint(self.view.bounds.size.width);
    root.yoga.height = YGPoint(self.view.bounds.size.height);
    ...
    child1.yoga.width = YGPoint(100);
    child1.yoga.height = YGPoint(100);
