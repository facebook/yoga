 ...
 *
 * clang-format off
 * @generated SignedSource<<c69e93249526f70b1adc2e90721ed26a>>
...
TEST(YogaTest, init_track_fixed_sizing) {
  YGConfigRef config = YGConfigNew();
...
TEST(YogaTest, justify_content_center) {
  YGConfigRef config = YGConfigNew();
...
TEST(YogaTest, justify_content_space_between) {
  YGConfigRef config = YGConfigNew();
...
TEST(YogaTest, justify_content_space_around) {
  YGConfigRef config = YGConfigNew();
  ...
  ASSERT_FLOAT_EQ(367, YGNodeLayoutGetLeft(root_child2));
  ASSERT_FLOAT_EQ(0, YGNodeLayoutGetTop(root_child2));
  ASSERT_FLOAT_EQ(100, YGNodeLayoutGetWidth(root_child2));
  ASSERT_FLOAT_EQ(100, YGNodeLayoutGetHeight(root_child2));
  ...
  ASSERT_FLOAT_EQ(367, YGNodeLayoutGetLeft(root_child0));
  ASSERT_FLOAT_EQ(0, YGNodeLayoutGetTop(root_child0));
  ASSERT_FLOAT_EQ(100, YGNodeLayoutGetWidth(root_child0));
  ASSERT_FLOAT_EQ(100, YGNodeLayoutGetHeight(root_child0));
  ...
  ASSERT_FLOAT_EQ(33, YGNodeLayoutGetLeft(root_child2));
  ASSERT_FLOAT_EQ(0, YGNodeLayoutGetTop(root_child2));
  ASSERT_FLOAT_EQ(100, YGNodeLayoutGetWidth(root_child2));
  ASSERT_FLOAT_EQ(100, YGNodeLayoutGetHeight(root_child2));
...
TEST(YogaTest, justify_content_space_evenly) {
  YGConfigRef config = YGConfigNew();
  ...
  ASSERT_FLOAT_EQ(350, YGNodeLayoutGetLeft(root_child2));
  ASSERT_FLOAT_EQ(0, YGNodeLayoutGetTop(root_child2));
  ASSERT_FLOAT_EQ(100, YGNodeLayoutGetWidth(root_child2));
  ASSERT_FLOAT_EQ(100, YGNodeLayoutGetHeight(root_child2));
...
TEST(YogaTest, align_content_start) {
  YGConfigRef config = YGConfigNew();

  YGNodeRef root = YGNodeNewWithConfig(config);
  YGNodeStyleSetAlignContent(root, YGAlignStart);
  YGNodeStyleSetPositionType(root, YGPositionTypeAbsolute);
...
TEST(YogaTest, align_content_end) {
  YGConfigRef config = YGConfigNew();
  ...
  ASSERT_FLOAT_EQ(0, YGNodeLayoutGetLeft(root_child0));
  ASSERT_FLOAT_EQ(200, YGNodeLayoutGetTop(root_child0));
  ASSERT_FLOAT_EQ(100, YGNodeLayoutGetWidth(root_child0));
  ASSERT_FLOAT_EQ(100, YGNodeLayoutGetHeight(root_child0));
...
TEST(YogaTest, align_content_center) {
  ...
  ASSERT_FLOAT_EQ(0, YGNodeLayoutGetLeft(root_child2));
  ASSERT_FLOAT_EQ(300, YGNodeLayoutGetTop(root_child2));
  ASSERT_FLOAT_EQ(100, YGNodeLayoutGetWidth(root_child2));
  ASSERT_FLOAT_EQ(100, YGNodeLayoutGetHeight(root_child2));
...
TEST(YogaTest, align_content_space_between) {
  YGConfigRef config = YGConfigNew();
...
TEST(YogaTest, align_content_space_around) {
  YGConfigRef config = YGConfigNew();
  ...
  ASSERT_FLOAT_EQ(0, YGNodeLayoutGetLeft(root_child2));
  ASSERT_FLOAT_EQ(367, YGNodeLayoutGetTop(root_child2));
  ASSERT_FLOAT_EQ(100, YGNodeLayoutGetWidth(root_child2));
  ASSERT_FLOAT_EQ(100, YGNodeLayoutGetHeight(root_child2));
...
TEST(YogaTest, align_content_space_evenly) {
  YGConfigRef config = YGConfigNew();
  ...
  ASSERT_FLOAT_EQ(0, YGNodeLayoutGetLeft(root_child2));
  ASSERT_FLOAT_EQ(350, YGNodeLayoutGetTop(root_child2));
  ASSERT_FLOAT_EQ(100, YGNodeLayoutGetWidth(root_child2));
  ASSERT_FLOAT_EQ(100, YGNodeLayoutGetHeight(root_child2));
...
TEST(YogaTest, justify_self_start) {
  YGConfigRef config = YGConfigNew();
...
TEST(YogaTest, justify_self_end) {
  YGConfigRef config = YGConfigNew();
...
TEST(YogaTest, justify_self_center) {
  YGConfigRef config = YGConfigNew();
  ...
  YGNodeRef root_child0 = YGNodeNewWithConfig(config);
  YGNodeStyleSetJustifySelf(root_child0, YGJustifyCenter);
  YGNodeStyleSetWidth(root_child0, 100);
  YGNodeStyleSetHeightPercent(root_child0, 100);
  YGNodeInsertChild(root, root_child0, 0);

  YGNodeRef root_child1 = YGNodeNewWithConfig(config);
  YGNodeStyleSetJustifySelf(root_child1, YGJustifyCenter);
  YGNodeStyleSetWidth(root_child1, 100);
  YGNodeStyleSetHeightPercent(root_child1, 100);
  YGNodeInsertChild(root, root_child1, 1);
  YGNodeCalculateLayout(root, YGUndefined, YGUndefined, YGDirectionLTR);
...
TEST(YogaTest, justify_self_stretch) {
  YGConfigRef config = YGConfigNew();
  ...
  YGNodeRef root_child1 = YGNodeNewWithConfig(config);
  YGNodeStyleSetJustifySelf(root_child1, YGJustifyStretch);
  YGNodeStyleSetHeightPercent(root_child1, 100);
  YGNodeInsertChild(root, root_child1, 1);
  YGNodeCalculateLayout(root, YGUndefined, YGUndefined, YGDirectionLTR);
...
TEST(YogaTest, align_self_start) {
  YGConfigRef config = YGConfigNew();
...
TEST(YogaTest, grid_align_self_center) {
  YGConfigRef config = YGConfigNew();
...
TEST(YogaTest, grid_align_self_stretch) {
  YGConfigRef config = YGConfigNew();
...
TEST(YogaTest, content_based_min_aspect_ratio) {
  ...
  YGNodeRef root_child0 = YGNodeNewWithConfig(config);
  YGNodeStyleSetWidth(root_child0, 150);
  YGNodeStyleSetAspectRatio(root_child0, 2 / 1);
  YGNodeInsertChild(root, root_child0, 0);

  YGNodeRef root_child1 = YGNodeNewWithConfig(config);
  YGNodeStyleSetHeight(root_child1, 100);
  YGNodeStyleSetAspectRatio(root_child1, 0.5 / 1);
  YGNodeInsertChild(root, root_child1, 1);
  YGNodeCalculateLayout(root, YGUndefined, YGUndefined, YGDirectionLTR);
...
TEST(YogaTest, auto_margins_inline_both) {
  YGConfigRef config = YGConfigNew();
...
TEST(YogaTest, auto_margins_block_both) {
  YGConfigRef config = YGConfigNew();
...
TEST(YogaTest, complex_all_features_combined) {
  ...
  YGNodeStyleSetAspectRatio(root_child3, 1 / 1);
  YGNodeInsertChild(root, root_child3, 3);
...
TEST(YogaTest, grid_display_none_items) {
  YGConfigRef config = YGConfigNew();
