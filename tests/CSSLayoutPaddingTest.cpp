...
TEST(CSSLayoutTest, child_with_padding_align_end1) {
  const CSSNodeRef root = CSSNodeNew();
  CSSNodeStyleSetJustifyContent(root, CSSJustifyFlexEnd);
  CSSNodeStyleSetAlignItems(root, CSSAlignFlexEnd);
  CSSNodeStyleSetWidth(root, 200);
  ...
  ASSERT_FLOAT_EQ(20, CSSNodeLayoutGetLeft(root_child0_child0));
  ASSERT_FLOAT_EQ(20, CSSNodeLayoutGetTop(root_child0_child0));
...
TEST(CSSLayoutTest, child_with_padding_align_end2) {
  const CSSNodeRef root = CSSNodeNew();
  CSSNodeStyleSetAlignItems(root, CSSAlignFlexEnd);
  CSSNodeStyleSetWidth(root, 200);
  CSSNodeStyleSetHeight(root, 200);
...
TEST(CSSLayoutTest, child_with_padding_align_end3) {
  const CSSNodeRef root = CSSNodeNew();
  CSSNodeStyleSetJustifyContent(root, CSSJustifyFlexEnd);
  CSSNodeStyleSetWidth(root, 200);
  CSSNodeStyleSetHeight(root, 200);
...
TEST(CSSLayoutTest, child_with_padding_align_end4) {
  const CSSNodeRef root = CSSNodeNew();
  CSSNodeStyleSetJustifyContent(root, CSSJustifyFlexEnd);
...
TEST(CSSLayoutTest, child_with_padding_align_end5) {
  const CSSNodeRef root = CSSNodeNew();
  CSSNodeStyleSetJustifyContent(root, CSSJustifyFlexEnd);
  CSSNodeStyleSetAlignItems(root, CSSAlignFlexEnd);
  CSSNodeStyleSetWidth(root, 200);
...
TEST(CSSLayoutTest, child_with_padding_align_end6) {
  const CSSNodeRef root = CSSNodeNew();
  ...
  ASSERT_FLOAT_EQ(100, CSSNodeLayoutGetLeft(root_child0));
  ASSERT_FLOAT_EQ(50, CSSNodeLayoutGetTop(root_child0));
  ASSERT_FLOAT_EQ(100, CSSNodeLayoutGetWidth(root_child0));
  ASSERT_FLOAT_EQ(100, CSSNodeLayoutGetHeight(root_child0));
...
TEST(CSSLayoutTest, child_with_padding_align_end7) {
  const CSSNodeRef root = CSSNodeNew();
...
TEST(CSSLayoutTest, child_with_padding_align_end8) {
  const CSSNodeRef root = CSSNodeNew();
  CSSNodeStyleSetJustifyContent(root, CSSJustifyCenter);
  CSSNodeStyleSetAlignItems(root, CSSAlignFlexEnd);
  CSSNodeStyleSetWidth(root, 200);
