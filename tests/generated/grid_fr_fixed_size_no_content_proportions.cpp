 ...
 *
 * clang-format off
 * @generated SignedSource<<f595792fef4cb5a7c375820a4f99c9d4>>
...
TEST(YogaTest, grid_fr_fixed_size_no_content_proportions) {
  ...
  ASSERT_FLOAT_EQ(67, YGNodeLayoutGetWidth(root_child1));
