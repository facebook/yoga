 ...
 *
 * @generated SignedSource<<7461378680453a6b7d053ba451b73c47>>
...
test('grid_fr_fixed_size_single_item', () => {
  ...
  try {
    ...
    expect(root_child7.getComputedHeight()).toBe(80);

    expect(root_child8.getComputedLeft()).toBe(140);
    expect(root_child8.getComputedTop()).toBe(120);
    expect(root_child8.getComputedWidth()).toBe(60);
    expect(root_child8.getComputedHeight()).toBe(80);
