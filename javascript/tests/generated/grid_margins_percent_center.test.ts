 ...
 *
 * @generated SignedSource<<825a9194a134704d96c4af55d4f2a6dd>>
...
test('grid_margins_percent_center', () => {
  ...
  try {
    ...
    expect(root_child0.getComputedTop()).toBe(9);
    ...
    expect(root_child0.getComputedLeft()).toBe(41);
    expect(root_child0.getComputedTop()).toBe(9);
    expect(root_child0.getComputedWidth()).toBe(20);
    expect(root_child0.getComputedHeight()).toBe(20);
