 ...
 *
 * clang-format off
 * @generated SignedSource<<2552db8a8cd3bbb0508eb8763d2d536c>>
 * generated by gentest/src/GentestDriver.ts from gentest/fixtures/grid_gap.html
 */
...
TEST(YogaTest, grid_gap) {
  ...
  YGNodeStyleSetGap(root, YGGutterRow, 40);
  YGNodeStyleSetGap(root, YGGutterColumn, 40);
  ...
  ASSERT_FLOAT_EQ(160, YGNodeLayoutGetLeft(root_child2));
  ...
  ASSERT_FLOAT_EQ(160, YGNodeLayoutGetLeft(root_child5));
  ...
  ASSERT_FLOAT_EQ(160, YGNodeLayoutGetLeft(root_child8));
