 ...
 *
 * @generated SignedSource<<bc4d71b1d20e35f7075cc3245cd082aa>>
...
test('grid_fr_no_sized_items_indefinite', () => {
  ...
  try {
    ...
    expect(root_child6.getComputedTop()).toBe(40);
    ...
    expect(root_child7.getComputedTop()).toBe(40);
    expect(root_child7.getComputedWidth()).toBe(0);
    expect(root_child7.getComputedHeight()).toBe(0);

    expect(root_child8.getComputedLeft()).toBe(40);
    expect(root_child8.getComputedTop()).toBe(40);
    expect(root_child8.getComputedWidth()).toBe(0);
    expect(root_child8.getComputedHeight()).toBe(0);
