 ...
 *
 * @generated SignedSource<<78aa51ef61488ce9bb39438077bed512>>
...
test('grid_spanning_items', () => {
  ...
  try {
    ...
    const root_child1 = Yoga.Node.create(config);
    root_child1.setPadding(Edge.All, 40);
...
test('grid_gap_percentage_definite_size_2', () => {
  ...
  try {
    ...
    const root_child1 = Yoga.Node.create(config);
    root_child1.setPadding(Edge.All, 20);
    root.insertChild(root_child1, 1);

    const root_child2 = Yoga.Node.create(config);
    root_child2.setPadding(Edge.All, 20);
    root_child2.setGridColumnStart(2);
    root_child2.setGridColumnEnd(5);
    root.insertChild(root_child2, 2);
    root.calculateLayout(undefined, undefined, Direction.LTR);
