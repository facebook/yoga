 ...
 *
 * @generated SignedSource<<70edbf6f1aeac2b16ef9bfaf8261fa44>>
...
public class grid_auto_rows {
  ...
  @Test
  public void test_grid_auto_rows() {
    ...
    rootGridAutoRows.addTrack(YogaGridTrackValue.points(10f));
    rootGridAutoRows.addTrack(YogaGridTrackValue.points(20f));
    rootGridAutoRows.addTrack(YogaGridTrackValue.points(30f));
    ...
    assertEquals(180f, root.getLayoutHeight(), 0.0f);
    ...
    assertEquals(30f, root_child5.getLayoutHeight(), 0.0f);

    assertEquals(0f, root_child6.getLayoutX(), 0.0f);
    assertEquals(150f, root_child6.getLayoutY(), 0.0f);
