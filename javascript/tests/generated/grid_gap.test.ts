 ...
 *
 * @generated SignedSource<<363695609014677ec0dcf2fc67047a25>>
...
test('grid_gap', () => {
  ...
  try {
    ...
    expect(root_child2.getComputedLeft()).toBe(160);
    ...
    expect(root_child5.getComputedLeft()).toBe(160);
    ...
    expect(root_child8.getComputedLeft()).toBe(160);
