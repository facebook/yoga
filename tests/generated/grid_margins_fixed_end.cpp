 ...
 *
 * clang-format off
 * @generated SignedSource<<b3fab067d694e6a265e635dc93e30a60>>
...
TEST(YogaTest, grid_margins_fixed_end) {
  ...
  ASSERT_FLOAT_EQ(58, YGNodeLayoutGetLeft(root_child0));
  ...
  ASSERT_FLOAT_EQ(124, YGNodeLayoutGetLeft(root_child0));
  ASSERT_FLOAT_EQ(27, YGNodeLayoutGetTop(root_child0));
  ASSERT_FLOAT_EQ(20, YGNodeLayoutGetWidth(root_child0));
  ASSERT_FLOAT_EQ(20, YGNodeLayoutGetHeight(root_child0));
