 ...
 *
 * clang-format off
 * @generated SignedSource<<f05640283dd86a50ed253d849513e39f>>
...
TEST(YogaTest, grid_fr_fixed_size_single_item) {
  ...
  ASSERT_FLOAT_EQ(80, YGNodeLayoutGetHeight(root_child7));

  ASSERT_FLOAT_EQ(140, YGNodeLayoutGetLeft(root_child8));
  ASSERT_FLOAT_EQ(120, YGNodeLayoutGetTop(root_child8));
  ASSERT_FLOAT_EQ(60, YGNodeLayoutGetWidth(root_child8));
  ASSERT_FLOAT_EQ(80, YGNodeLayoutGetHeight(root_child8));
