 ...
 *
 * @generated SignedSource<<861fa6dc5d522c231d10ec23d4abcbb3>>
...
test('grid_minmax_column_fixed_width_within_range', () => {
  ...
  try {
    ...
    expect(root_child7.getComputedWidth()).toBe(30);
    expect(root_child7.getComputedHeight()).toBe(40);

    expect(root_child8.getComputedLeft()).toBe(70);
    ...
    expect(root_child6.getComputedLeft()).toBe(70);
    expect(root_child6.getComputedTop()).toBe(80);
    expect(root_child6.getComputedWidth()).toBe(40);
    expect(root_child6.getComputedHeight()).toBe(40);
