...
<YogaRoot useWebDefaults={false}>
  <Node style={{width: 350, height: 350, padding: 20, gap: 20}}>
    <Node style={{flex: 1}} />
    <Node style={{flex: 1}} />
    <Node style={{flex: 1}} />
  </Node>
...
type YogaRootProps = Readonly<{
  children: React.ReactNode;
  useWebDefaults?: boolean;
}>;

function YogaRoot({children, useWebDefaults}: YogaRootProps) {
