 ...
 *
 * @generated SignedSource<<43ea83a02f277bc06e5ea385bbff8f96>>
...
test('grid_margins_auto_margins_override_stretch', () => {
  ...
  try {
    ...
    root_child6.setMeasureFunc(instrinsicSizeMeasureFunc.bind({text: "HH​HH", flexDirection: FlexDirection.Column}));
    ...
    expect(root_child6.getComputedTop()).toBe(105);
