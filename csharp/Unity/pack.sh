...
mkdir -p $tests
tar -C ../tests/Facebook.Yoga -cf - \
  YGAbsolutePositionTest.cs \
  YGAlignContentTest.cs \
  YGAlignItemsTest.cs \
  YGAlignSelfTest.cs \
  YGBorderTest.cs \
  YGFlexDirectionTest.cs \
  YGFlexTest.cs \
  YGFlexWrapTest.cs \
  YGJustifyContentTest.cs \
  YGMarginTest.cs \
  YGMinMaxDimensionTest.cs \
  YGPaddingTest.cs \
  YogaNodeCreateTest.cs \
  YogaNodeTest.cs \
  | tar -C $tests -xf -
