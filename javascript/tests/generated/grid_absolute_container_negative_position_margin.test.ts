 ...
 *
 * @generated SignedSource<<20e55b48c2968df1f8cf5309924eb163>>
...
test('grid_absolute_container_negative_position_margin', () => {
  ...
  try {
    ...
    root_child0.setPosition(Edge.Right, -15);
    root_child0.setPosition(Edge.Top, -5);
    root_child0.setMargin(Edge.Top, 1);
    root_child0.setMargin(Edge.Right, 2);
    root_child0.setMargin(Edge.Bottom, 3);
    root_child0.setMargin(Edge.Left, 4);
    root.insertChild(root_child0, 0);

    const root_child1 = Yoga.Node.create(config);
    root_child1.setPositionType(PositionType.Absolute);
    root_child1.setPosition(Edge.Bottom, -25);
    root_child1.setPosition(Edge.Left, -35);
    root_child1.setMargin(Edge.Top, 1);
    root_child1.setMargin(Edge.Right, 2);
    root_child1.setMargin(Edge.Bottom, 3);
    root_child1.setMargin(Edge.Left, 4);
    ...
    expect(root_child0.getComputedLeft()).toBe(193);
    expect(root_child0.getComputedTop()).toBe(-4);
    expect(root_child0.getComputedWidth()).toBe(0);
    expect(root_child0.getComputedHeight()).toBe(0);

    expect(root_child1.getComputedLeft()).toBe(-31);
    expect(root_child1.getComputedTop()).toBe(182);
    ...
    expect(root_child4.getComputedTop()).toBe(10);
    ...
    expect(root_child7.getComputedLeft()).toBe(120);
    expect(root_child7.getComputedTop()).toBe(50);
