 ...
 *
 * clang-format off
 * @generated SignedSource<<8e491be39dda9454e4d97ca4bac78ebc>>
...
TEST(YogaTest, grid_minmax_column_fixed_width_within_range) {
  ...
  ASSERT_FLOAT_EQ(30, YGNodeLayoutGetWidth(root_child7));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetHeight(root_child7));

  ASSERT_FLOAT_EQ(70, YGNodeLayoutGetLeft(root_child8));
  ...
  ASSERT_FLOAT_EQ(70, YGNodeLayoutGetLeft(root_child6));
  ASSERT_FLOAT_EQ(80, YGNodeLayoutGetTop(root_child6));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetWidth(root_child6));
  ASSERT_FLOAT_EQ(40, YGNodeLayoutGetHeight(root_child6));
