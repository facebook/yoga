 ...
 *
 * @generated SignedSource<<a27634978a8654f596abb7b3046a35e9>>
...
test('grid_align_items_baseline_complex', () => {
  ...
  try {
    ...
    const root_child6_child0 = Yoga.Node.create(config);
    root_child6_child0.setHeight(10);
    root_child6.insertChild(root_child6_child0, 0);
    ...
    const root_child7_child0 = Yoga.Node.create(config);
    root_child7_child0.setHeight(5);
    root_child7.insertChild(root_child7_child0, 0);
    ...
    expect(root_child2_child0.getComputedWidth()).toBe(20);
    ...
    expect(root_child6_child0.getComputedLeft()).toBe(0);
    expect(root_child6_child0.getComputedTop()).toBe(0);
    expect(root_child6_child0.getComputedWidth()).toBe(20);
    expect(root_child6_child0.getComputedHeight()).toBe(10);

    expect(root_child7.getComputedLeft()).toBe(40);
    expect(root_child7.getComputedTop()).toBe(95);
    expect(root_child7.getComputedWidth()).toBe(20);
    expect(root_child7.getComputedHeight()).toBe(20);

    expect(root_child7_child0.getComputedLeft()).toBe(0);
    expect(root_child7_child0.getComputedTop()).toBe(0);
    expect(root_child7_child0.getComputedWidth()).toBe(20);
    expect(root_child7_child0.getComputedHeight()).toBe(5);
    ...
    expect(root_child8.getComputedLeft()).toBe(20);
    expect(root_child8.getComputedTop()).toBe(80);
    expect(root_child8.getComputedWidth()).toBe(20);
    expect(root_child8.getComputedHeight()).toBe(20);
  } finally {
