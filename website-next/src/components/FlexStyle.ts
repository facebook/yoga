    ...
    try {
      switch (key) {
        ...
        case 'marginTop':
          ...
          break;
        case 'marginInline':
          node.setMargin(Edge.Vertical, style.marginInline);
          break;
        case 'marginBlock':
          node.setMargin(Edge.Horizontal, style.marginBlock);
          break;
        case 'maxHeight':
        ...
        case 'paddingTop':
          ...
          break;
        case 'paddingInline':
          node.setPadding(Edge.Vertical, style.paddingInline);
          break;
        case 'paddingBlock':
          node.setPadding(Edge.Horizontal, style.paddingBlock);
          break;
        case 'position':
        ...
        case 'top':
          ...
          break;
        case 'insetInline':
          node.setPosition(Edge.Vertical, style.insetInline);
          break;
        case 'insetBlock':
          node.setPosition(Edge.Horizontal, style.insetBlock);
          break;
        case 'inset':
