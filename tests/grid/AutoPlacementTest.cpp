...
TEST_F(GridAutoplacementTest, places_items_with_definite_positions) {
    createGridItem(GridLine::fromInteger(1), GridLine::fromInteger(3), 
                GridLine::fromInteger(1), GridLine::fromInteger(2));
    createGridItem(GridLine::fromInteger(2), GridLine::fromInteger(4), 
...
TEST_F(GridAutoplacementTest, handles_overlapping_definite_row_items) {
    createGridItem(GridLine::auto_(), GridLine::span(2), 
                GridLine::fromInteger(1), GridLine::fromInteger(2));
    createGridItem(GridLine::auto_(), GridLine::span(2), 
                GridLine::fromInteger(1), GridLine::fromInteger(2));
...
TEST_F(GridAutoplacementTest, avoids_overlaps_with_definite_column_items) {
    createGridItem(GridLine::fromInteger(1), GridLine::fromInteger(3), 
                GridLine::fromInteger(1), GridLine::fromInteger(3));
...
TEST_F(GridAutoplacementTest, handles_negative_grid_line_references) {
    ...
    auto node1 = createGridItem(GridLine::fromInteger(-5), GridLine::fromInteger(-4));
    
    // .two { grid-column-start: 1; grid-column-end: 2; grid-row-start: 1; grid-row-end: 2; }
    auto node2 = createGridItem(GridLine::fromInteger(1), GridLine::fromInteger(2), 
                GridLine::fromInteger(1), GridLine::fromInteger(2));
...
TEST_F(GridAutoplacementTest, handles_negative_grid_lines_with_row_positioning) {
    ...
    // .one { grid-column-start: -5; grid-column-end: -4; grid-row-start: 2; grid-row-end: 3; }
    auto node1 = createGridItem(GridLine::fromInteger(-5), GridLine::fromInteger(-4),
                            GridLine::fromInteger(2), GridLine::fromInteger(3));
    
    // .two { grid-row-start: 1; grid-row-end: 2; }
    auto node2 = createGridItem(GridLine::auto_(), GridLine::auto_(),
                            GridLine::fromInteger(1), GridLine::fromInteger(2));
...
TEST_F(GridAutoplacementTest, handles_negative_and_positive_grid_lines_auto_row) {
    ...
    // .one { grid-column-start: -5; grid-column-end: -4; grid-row-start: 1; grid-row-end: 2; }
    auto node1 = createGridItem(GridLine::fromInteger(-5), GridLine::fromInteger(-4),
                            GridLine::fromInteger(1), GridLine::fromInteger(2));
