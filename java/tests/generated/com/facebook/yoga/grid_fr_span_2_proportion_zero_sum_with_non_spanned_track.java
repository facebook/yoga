 ...
 *
 * @generated SignedSource<<2facd892831c13539a61ac6578b5cb4b>>
...
public class grid_fr_span_2_proportion_zero_sum_with_non_spanned_track {
  ...
  @Test
  public void test_grid_fr_span_2_proportion_zero_sum_with_non_spanned_track() {
    ...
    rootGridTemplateColumns.addTrack(YogaGridTrackValue.fr(0f));
    rootGridTemplateColumns.addTrack(YogaGridTrackValue.fr(0f));
    rootGridTemplateColumns.addTrack(YogaGridTrackValue.fr(0f));
