 ...
 *
 * clang-format off
 * @generated SignedSource<<4d06d4f2e0a752dfdd6b183533c53b92>>
...
TEST(YogaTest, grid_margins_auto_margins_override_stretch) {
  ...
  YGNodeSetContext(root_child6, (void*)"HH​HH");
  YGNodeSetMeasureFunc(root_child6, &facebook::yoga::test::IntrinsicSizeMeasure);
  ...
  ASSERT_FLOAT_EQ(105, YGNodeLayoutGetTop(root_child6));
